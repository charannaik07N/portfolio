  ...
  return (
    <section id="skills" className="py-20 bg-gradient-to-b from-background to-muted/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-cyan-200/20 dark:bg-cyan-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-cyan-600 dark:text-cyan-400">Technical Expertise</span>
          </motion.div>
        ...
        >
          {[
            ...
            { icon: Award, number: '15+', label: 'Projects Built', color: 'from-blue-600 to-cyan-500' }
          ].map((stat, index) => {
