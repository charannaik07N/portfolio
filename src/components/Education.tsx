          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              {index < education.length - 1 && (
                <div className="absolute left-6 top-20 w-0.5 h-40 bg-gradient-to-b from-blue-600 to-cyan-500"></div>
              )}
              
              <div className="flex items-start gap-6 mb-12">
                {/* Timeline dot */}
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-full flex items-center justify-center">
                ...
                <div className="flex-1 bg-background border border-border rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h4 className="font-semibold mb-3 text-cyan-600">Relevant Coursework</h4>
