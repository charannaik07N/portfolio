...
export function Hero() {
  ...
  const handleDownloadResume = () => {
    window.open('https://drive.google.com/file/d/1j5Vf-GwcdaLTKdLHrxeb81vbRVXjMTQL/view?usp=sharing', '_blank');
  };
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-cyan-900/20"></div>
        ...
        <div className="text-center">
          ...
          >
            <Button 
              ...
              className="bg-blue-600 hover:bg-blue-700 hover:brightness-105 hover:scale-[1.02] text-white"
            >
