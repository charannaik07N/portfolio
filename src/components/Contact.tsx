          ...
          >
            <div className="max-w-md mx-auto bg-background border border-border rounded-xl p-8 shadow-sm">
              ...
              <Button 
                ...
                className="bg-blue-600 hover:bg-blue-700 hover:brightness-105"
              >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl border border-border">
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 hover:brightness-105 text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
